...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Kslinghook/source/master/pt-BR.json", function (json) {
    ...
    var basicBot = {
        ...
        chatLink: "https://rawgit.com/Kslinghook/source/master/pt-BR.json",
        chat: null,
        loadChat: loadChat,
            ...
            languageCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.get("https://rawgit.com/Kslinghook/source/master/lang/langIndex.json", function (json) {
                            var langIndex = json;
